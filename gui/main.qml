        ...
        ColumnLayout {
            ...
            StackLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ButtonMD3 {text: qsTr(">"); onClicked: {display_stack.currentIndex = display_stack.regulations_mode_tracts_prm_prd_2_page_index}}
                        ButtonMD3 {text: qsTr("0. Выход"); onClicked: {display_stack.currentIndex = display_stack.regulations_mode_page_index}}
                    }
                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ButtonMD3 {text: qsTr("<"); onClicked: {display_stack.currentIndex = display_stack.regulations_mode_tracts_prm_prd_1_page_index}}
                        ButtonMD3 {text: qsTr("0. Выход"); onClicked: {display_stack.currentIndex = display_stack.regulations_mode_page_index}}
                    }
                }
